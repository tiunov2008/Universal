...
if ( ! function_exists( 'universal_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function universal_posted_by() {
		$byline = sprintf(
	...
	function universal_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			if ( $categories_list ) {
				...
				printf( '<span class="cat-links">' . esc_html__( 'Posted in %1$s', 'universal' ) . '</span>', $categories_list ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			}
			...
			if ( $tags_list ) {
				...
				printf( '<span class="tags-links">' . esc_html__( 'Tagged %1$s', 'universal' ) . '</span>', $tags_list ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			}
		}
...
if ( ! function_exists( 'universal_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function universal_post_thumbnail() {
